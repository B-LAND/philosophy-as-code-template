...
How a martial artist's philosophy became an AI design principle.
...
Why harnesses without philosophy ritualize. The full argument with case study.

哲学なきハーネスがなぜ形骸化するか。論証とケーススタディの全文。
